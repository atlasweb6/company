...
('Italiano', 'it', 'it_IT.UTF-8,it_IT,italian', 'it.png', 'italian', 1, 1);


SET @languageid = (SELECT language_id FROM `oc_language` WHERE `code` = 'it');

/*--todo-- duplicate any existent oc_customer_group_description for with the italian language_id*/
INSERT INTO `oc_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, @languageid, 'Predefinito', 'Clienti');


INSERT INTO `oc_geo_zone` (`name`, `description`, `date_modified`, `date_added`) VALUES
('IVA - Italia', 'Zona - IVA Territorio Italiano', '0000-00-00 00:00:00', '2014-01-12 23:27:13');

SET @vatgeozoneita = (SELECT `geo_zone_id` FROM `oc_geo_zone` WHERE `name` = 'IVA - Italia');


INSERT INTO `oc_zone_to_geo_zone` (`country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
(105,	0, @vatgeozoneita,	'2013-10-01 00:00:00',	'2013-10-01 00:00:00');



INSERT INTO `oc_tax_rate` ( `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
(@vatgeozoneita, 'IVA (22.0%)', '22.0000', 'P', '2013-10-01 00:00:00', '2013-10-01 00:00:00');
...
INSERT INTO `oc_information_description` SET title='Termini e condizioni', description='&lt;p&gt;Termini e condizioni&lt;/p&gt;',language_id=@languageid, information_id=5;
INSERT INTO `oc_information_description` SET title='Privacy', description='<p>Nota Informativa ex art. 13 del D. Lgs. 196/2003</p>
<p>I dati personali degli utenti forniti con la procedura di registrazione sono trattati in forma autorizzata.</p>
<p>Il responsabile del sito considera e tratta le informazioni sui dati personali che l&#39;Utente inserisce e diffonde tramite il Servizio, alla stregua della corrispondenza privata.</p>
<p>Il responsabile del sito pertanto, non controllerà, diffonderà autonomamente, né comunicherà tali informazioni, così come le informazioni relative all&#39;Utente, salvo quanto previsto nelle presenti note.</p>
<p>I dati personali dell&#39;Utente verranno trattati:</p>
<p>per la gestione, erogazione dei diversi servizi e per la relativa assistenza</p>
<p>per l&#39;elaborazione di analisi statistiche e di mercato</p>
<p>per l&#39;invio di comunicazioni relative a servizi e iniziative il responsabile del sito</p>
<p>per l&#39;invio di informazioni relative a servizi business-to-business e business-to consumer e sulle eventuali promozioni e/o servizi presentati sul sito. L&#39;Utente riconosce che il responsabile del sito potrà intervenire sulle predette informazioni, ove ritenga in buona fede che tale attività sia necessaria per:</p>
<p>a. conformarsi a prescrizioni di legge;</p>
<p>b. adeguarsi a un provvedimento legale, inclusa una disposizione dell&#39;Autorità Giudiziaria o di altra autorità competente;</p>
<p>c. far valere i propri diritti ai sensi delle presenti note;</p>
<p>d. difendersi da contestazioni di terzi che asseriscano che tali contenuti violano i loro diritti;</p>
<p>e. tutelare gli interessi del responsabile del sito o di terzi.</p>
<p>L&#39;Utente riconosce e concorda che il responsabile del sito potrà avere accesso alle informazioni o ai contenuti diffusi tramite il Servizio, in tutti i casi in cui tale accesso si renda necessario al fine di individuare o risolvere un problema tecnico, ovvero per rispondere a reclami relativi al Servizio.</p>
<p>L&#39;Utente riconosce e concorda che l&#39;elaborazione e il trattamento tecnico delle informazioni è o può rendersi necessario per:</p>
<p>f. inviare o ricevere tali dati;</p>
<p>g. eseguire le funzioni di pianificazione o programmazione;</p>
<p>h. conformarsi alle specifiche tecniche richieste dai network di connessione in rete;</p>
<p>i. conformarsi alle specifiche tecniche del Servizio.</p>
<p>Il responsabile del sito è autorizzato a trattare ed archiviare nei propri database il nominativo, il tipo di servizio, i resoconti dell&#39;attività di servizio ed altre informazioni dell&#39;Utente, che riguardino il presente Contratto o qualsiasi Servizio fornito in virtù di esso.</p>
<p>L&#39;Utente autorizza il trattamento da parte del responsabile del sito di tali dati per le finalità inerenti l&#39;esecuzione del presente Contratto e la prestazione dei servizi in esso contemplati.</p>
<p>Inoltre, ai sensi dell&#39;art. 7 del D. Lgs. 196/2003, l&#39;Utente autorizza il responsabile del sito all&#39;archiviazione, all&#39;elaborazione e alla comunicazione di dati relativi all&#39;Utente, con le seguenti finalità: servizio clienti (amministrazione, contabilità, gestione dei contratti, ordini, fatturazione, recupero crediti), marketing, promozione, analisi statistiche, indagini sulla soddisfazione della clientela, revisioni, archiviazione di dati storici, informazioni pre-contrattuali.</p>
	', language_id=@languageid, information_id=3;

	INSERT INTO `oc_information_description` SET title='Info Spedizioni', description='<h3>Costi Spedizione & Tempi</h3>
<span>Alcune metodi di spedizione offerti sono &#34;tracciabili&#34; e, quindi, possono essere costantemente seguiti durante le varie tappe della spedizione. Questo servizio, però, non è disponibile per tutti gli ordini. Avrete la possibilità di scegliere il metodo di spedizione del vostro pacco direttamente sulla pagina degli acquisti.</span></p>
<p>Gli ordini effettuati vengono normalmente consegnati il giorno lavorativo successivo a quello dell&#39;ordine.
Le spedizioni all&#39;interno dell&#39;UE possono richiedere oltre 7 giorni lavorativi. 
Le spedizione verso i paesi extra-UE possono richiedere oltre 2 settimane.</p>
<p><span>Gli ordini che vengono spediti con nr di Tracking tendono ad arrivare con maggiore velocit&agrave;.
Appena il collo viene consegnato al corriere riceverete un numero di Tracking che vi fornirà dettagli sulla situazione della consegna.</span></p>
<h3>Esclusione di responsabilità:</span></h3>
<p><span>1. L\&#39;obiettivo principale &egrave; di garantire che l&#39;ordine arrivi a destinazione il prima possibile. Sono però i clienti e/o destinatari ad assumersi la responsabilità, al momento dell&#39;acquisto, dei prodotti ricevuti e dei dettagli di consegna forniti (controllare sempre che siano corretti).</span></p>
<p><span>2. Non &egrave; possibile assumerci nessuna responsabilità per eventuali perdite sostenute dal cliente o dal destinatario, in termini di spese di trasporto non rimborsabili e/o costi aggiuntivi per la consegna della merce o per la sostituzione di questa.</span></p>
<p><span>3. Nel caso in cui riceviate un articolo errato o danneggiato, vi invitiamo a contattarci telefonicamente o via email entro tre giorni dalla data di ricezione dell&#39;ordine, preferibilmente con una fotografia del pacco e del suo contenuto.</span></span></p>
<p><span> Si prega di non rimandare prodotti senza prima averci contattato ed aver ricevuto un numero RMA.</span></span></p>
<p><span> I rimborsi sono possibili, da parte dello spedizioniere, se con spedizione assicurata. I costi per la spedizione di partenza e il dazio per l&#39;importazione non sono rimborsabili. Stesso discorso vale per i costi sostenuti per il reso e per l&#39;assicurazione dell&#39;articolo, salvo accordi diversi.</span></p>
<p><span> Come già riportato in &#34;Termini &amp; Condizioni&#34; la responsabilità è a carico del cliente/destinatario una volta che l&#39;ordine viene spedito.</span></p>', language_id=@languageid, information_id=6;
...
INSERT INTO `oc_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, @languageid, 'Natale'),
(7, @languageid, 'Compleanno'),
(8, @languageid, 'Generale');

INSERT INTO `oc_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, @languageid, 'Disponibile'),
(8, @languageid, 'Su Ordinazione'),
(5, @languageid, 'Non disponibile'),
(6, @languageid, 'In 2-3 Giorni');

INSERT INTO `oc_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, @languageid, 'In lavorazione'),
(3, @languageid, 'Completato'),
(2, @languageid, 'In attesa del prodotto');

INSERT INTO `oc_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, @languageid, 'Arrivato Danneggiato (DOA)'),
(2, @languageid, 'Ricevuto prodotto Errato'),
(3, @languageid, 'Errore Ordine'),
(4, @languageid, 'Difettoso. Si prega di fornire dettagli'),
(5, @languageid, 'Altro. Si prega di fornire dettagli');

INSERT INTO `oc_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, @languageid, 'Rimborsato'),
(2, @languageid, 'Credito Inviato'),
(3, @languageid, 'Sostituzione Inviata');

INSERT INTO `oc_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, @languageid, 'In Lavorazione'),
(3, @languageid, 'Spedito'),
(7, @languageid, 'Cancellato'),
(5, @languageid, 'Completato'),
(8, @languageid, 'Negato'),
(9, @languageid, 'Restituzione Cancellata'),
(10, @languageid, 'Fallito'),
(11, @languageid, 'Rifiutato'),
(12, @languageid, 'Restituito'),
(13, @languageid, 'Chargeback'),
(1, @languageid, 'In corso'),
(16, @languageid, 'Annullato'),
(15, @languageid, 'Processato'),
(14, @languageid, 'Scaduto');

INSERT INTO `oc_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, @languageid, 'Centimetri', 'cm'),
(2, @languageid, 'Millimetri', 'mm'),
(3, @languageid, 'Pollici', 'in');

INSERT INTO `oc_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, @languageid, 'Chilogrammi', 'kg'),
(2, @languageid, 'Grammi', 'g'),
(5, @languageid, 'Libbre ', 'lb'),
(6, @languageid, 'Once', 'oz');
...
INSERT INTO `oc_banner_image_description`(`banner_image_id`, `banner_id`, `title`, `language_id`) (SELECT `banner_image_id`, `banner_id`, `title`, @languageid FROM `oc_banner_image_description` WHERE language_id = 1);
...
/*--todo-- translate more default descriptions */

/*
NOTE: this part is facultative and not suggested for NON italian opencart.
*/


/* updating the main settings*/
/*fixing default invoice name without the 2013 (The year can be added/fixed with a module)*/
UPDATE `oc_setting` SET
`value` ='INV'
...
UPDATE `oc_setting` SET
`value` ='Negozio'
WHERE `key` ='config_title';

UPDATE `oc_setting` SET
`value` ='vendita, prodotti, ecommerce'
WHERE `key` ='config_meta_keyword';

UPDATE `oc_setting` SET
`value` ='Negozio'
WHERE `key` ='config_meta_description';
...
/*`value` ='3924' if you want to add Rome*/

UPDATE `oc_tax_class` SET
`title` ='Prodotti Tassabili',
`description` ='Prodotti Tassabili'
WHERE `tax_class_id` ='9';
UPDATE `oc_tax_class` SET
`title` ='Prodotti Scaricabili',
`description` ='Prodotti Scaricabili'
...
UPDATE `oc_setting` SET
`value` ='0'
WHERE `key` ='config_currency_auto';
...
UPDATE `oc_setting` SET
`value` ='1'
WHERE `key` ='config_affiliate_approval';
...
UPDATE `oc_setting` SET
`value` ='25000000'
WHERE `key` ='config_file_ext_allowed';


/* do not show weight in the cart */
UPDATE `oc_setting` SET
`value` ='0'
WHERE `key` ='config_cart_weight';

/* checkout for guests */
UPDATE `oc_setting` SET
`value` ='0'
WHERE `key` ='config_checkout_guest';
